...
int main(int argc, char* argv[]) {
  ...
  Model* arenaGround = new ArenaGround("arenaGround", 0);

  int ugv_modelId = 0;
  Model* groundRobot = new FourWheelRobot("ugv", 0);
  // SimuImu* imu = new SimuImu(groundRobot, "imu", ugv_modelId, 0);
  // SimuUsGL* us_gl = new SimuUsGL(groundRobot, "us", ugv_modelId, 0);
  // SimuCameraGL* cam_bas = new SimuCameraGL(groundRobot, "bottom camera", 320, 240, 880, 0, ugv_modelId, 0);
  //
